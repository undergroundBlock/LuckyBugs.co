...
// // import styles from './NftBoxes.module.css'

// import Web3 from 'web3'
// import { EventData } from 'web3-eth-contract'
// import lotteryJson from '~/contract/contract.json'
...
// //     <p className={styles.text}>Subscribe to get info on our project before everyone else</p>
// //     <form className={styles.emailSubscriptionForm} onSubmit={handleSubmit}>
// //       <input
// //         type="email"
